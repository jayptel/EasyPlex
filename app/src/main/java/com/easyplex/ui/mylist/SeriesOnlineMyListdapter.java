 ...
 * @author Yobex.
 */
public class SeriesOnlineMyListdapter extends RecyclerView.Adapter<SeriesOnlineMyListdapter.MainViewHolder> {
    ...
    public SeriesOnlineMyListdapter(MediaRepository mediaRepository,AuthRepository authRepository,DeleteFavoriteDetectListner deleteFavoriteDetectListner) {
    ...
    @NonNull
    @Override
    public SeriesOnlineMyListdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {


        ItemFavBinding binding = ItemFavBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);

        return new SeriesOnlineMyListdapter.MainViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull SeriesOnlineMyListdapter.MainViewHolder holder, int position) {
    ...
    class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final int position) {
            ...
            binding.deleteFromHistory.setOnClickListener(v -> {
                ...
                movieoverview.setText(context.getString(R.string.are_you_sure_to_delete_from_your_watching_history)+" "+myListMedia.getName()+context.getString(R.string.from_your_lists));

                dialog.findViewById(R.id.view_delete_from_history).setOnClickListener(v12 -> {

                    authRepository.getDeleteSerieOnline(myListMedia.getId())
                            .subscribeOn(Schedulers.io())
                            .observeOn(AndroidSchedulers.mainThread())
                            .cache()
                            .subscribe(new Observer<StatusFav>() {
                                @Override
            ...
            binding.rootLayout.setOnClickListener(view -> mediaRepository.getSerie(myListMedia.getId())
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribe(new Observer<Media>() {
                        ...
                        public void onError(@NotNull Throwable e) {
                            ...
                            Toast.makeText(context, context.getString(R.string.not_found_series), Toast.LENGTH_SHORT).show();
                        }
