 ...
 * @author Yobex.
 */
public class SeriesMyListdapter extends RecyclerView.Adapter<SeriesMyListdapter.MainViewHolder> {

    private List<Series> castList;
    private Context context;
    private final CompositeDisposable compositeDisposable = new CompositeDisposable();
    private final MediaRepository mediaRepository;

    public SeriesMyListdapter(MediaRepository mediaRepository) {
        this.mediaRepository = mediaRepository;
    }

    public void addToContent(List<Series> castList, Context context) {
    ...
    @NonNull
    @Override
    public SeriesMyListdapter.MainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {


        ItemFavBinding binding = ItemFavBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);

        return new SeriesMyListdapter.MainViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull SeriesMyListdapter.MainViewHolder holder, int position) {
    ...
    class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final int position) {
            ...
            final Series myListMedia = castList.get(position);
            ...
            binding.deleteFromHistory.setOnClickListener(v -> {
                ...
                dialog.findViewById(R.id.view_delete_from_history).setOnClickListener(v12 -> {
                    ...
                    compositeDisposable.add(Completable.fromAction(() -> mediaRepository.removeFavoriteSeries(myListMedia))
