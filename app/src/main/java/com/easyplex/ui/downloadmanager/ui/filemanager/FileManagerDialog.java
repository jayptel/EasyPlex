...
package com.easyplex.ui.downloadmanager.ui.filemanager;
...
import com.easyplex.databinding.ActivityFilemanagerDialogBinding;
...
import com.easyplex.ui.downloadmanager.ui.errorreport.ErrorReportDialog;
        ...
        implements FileManagerAdapter.ViewHolder.ClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if (!intent.hasExtra(TAG_CONFIG)) {
            Timber.e("To work need to set intent with FileManagerConfig in startActivity()");
