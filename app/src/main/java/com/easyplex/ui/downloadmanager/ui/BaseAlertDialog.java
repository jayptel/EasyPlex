...
public class BaseAlertDialog extends DialogFragment
{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState)
    {
        ...
        String message = null;
        if (args != null) {
            message = args.getString(TAG_MESSAGE);
        }
        String positiveText = null;
        if (args != null) {
            positiveText = args.getString(TAG_POS_TEXT);
        }
        String negativeText = null;
        if (args != null) {
            negativeText = args.getString(TAG_NEG_TEXT);
        }
        String neutralText = null;
        if (args != null) {
            neutralText = args.getString(TAG_NEUTRAL_BUTTON);
        }
        int resIdView = 0;
        if (args != null) {
            resIdView = args.getInt(TAG_RES_ID_VIEW);
        }
        boolean autoDismiss = false;
        if (args != null) {
            autoDismiss = args.getBoolean(TAG_AUTO_DISMISS);
        }
