...
package com.easyplex.ui.downloadmanager.ui.adddownload;
...
import com.easyplex.ui.downloadmanager.core.exception.FreeSpaceException;
import com.easyplex.ui.downloadmanager.core.exception.HttpException;
import com.easyplex.ui.downloadmanager.core.exception.NormalizeUrlException;
import com.easyplex.ui.downloadmanager.core.model.DownloadEngine;
...
import com.easyplex.ui.downloadmanager.core.urlnormalizer.NormalizeUrl;
import com.easyplex.ui.downloadmanager.core.utils.DigestUtils;
...
public class AddDownloadViewModel extends AndroidViewModel
{
    ...
    public void initParams(AddInitParams initParams)
    {
        ...
        params.setType(initParams.type);
        params.setMediaId(initParams.mediaId);
        params.setMediaName(initParams.mediaName);
        params.setMediabackdrop(initParams.mediabackdrop);
        params.setReferer(initParams.refer);
    ...
    private DownloadInfo makeDownloadInfo(Uri dirPath) throws NormalizeUrlException
    {
        ...
        String mediaName = params.getMediaName();

        String mediaType = params.getType();

        String mediaId = params.getMediaId();

        String mediaBackdrop = params.getMediabackdrop();

        String refer = params.getReferer();
        ...
        DownloadInfo info = new DownloadInfo(dirPath, url, fileName,mediaName,mediaType,mediaId,mediaBackdrop,refer);

        info.mediaName = params.getMediaName();
        info.mediatype = params.getType();
        info.mediaId = params.getMediaId();
        info.mediaBackdrop = params.getMediabackdrop();
