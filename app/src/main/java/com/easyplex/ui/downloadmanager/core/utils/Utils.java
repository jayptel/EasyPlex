...
package com.easyplex.ui.downloadmanager.core.utils;
...
import com.easyplex.ui.downloadmanager.core.filter.DownloadFilter;
import com.easyplex.ui.downloadmanager.core.filter.DownloadFilterCollection;
...
import com.easyplex.ui.downloadmanager.core.sorting.DownloadSorting;
import com.easyplex.ui.downloadmanager.core.sorting.DownloadSortingComparator;
import com.easyplex.ui.downloadmanager.core.system.FileSystemFacade;
import com.easyplex.ui.downloadmanager.core.system.SafFileSystem;
...
import com.easyplex.ui.downloadmanager.receiver.BootReceiver;
import com.easyplex.ui.downloadmanager.ui.main.DownloadItem;
import com.easyplex.ui.downloadmanager.ui.main.drawer.DrawerGroup;
import com.easyplex.ui.downloadmanager.ui.main.drawer.DrawerGroupItem;
...
import static com.easyplex.ui.downloadmanager.core.utils.MimeTypeUtils.DEFAULT_MIME_TYPE;
import static com.easyplex.ui.downloadmanager.core.utils.MimeTypeUtils.MIME_TYPE_DELIMITER;
...
public class Utils {
    ...
    public static Intent makeShareUrlIntent(@NonNull List<String> urlList) {
        ...
        if (!urlList.isEmpty()) {
            if (urlList.size() == 1)
                sharingIntent.putExtra(Intent.EXTRA_TEXT, urlList.get(0));
            else
    ...
    public static void enableBrowserLauncherIcon(@NonNull Context context, boolean enable) {
        ...
        pm.setComponentEnabledSetting(
                new ComponentName(context, "com.easyplex.ui.downloadmanager.ui.browser.BrowserIcon"),
    ...
    public static void disableBrowserFromSystem(@NonNull Context context, boolean disable) {
        ...
        int flag = (disable ?
                ...
                PackageManager.COMPONENT_ENABLED_STATE_ENABLED);
        pm.setComponentEnabledSetting(
                new ComponentName(context, "com.easyplex.ui.downloadmanager.ui.browser.Browser"),
                flag, PackageManager.DONT_KILL_APP);
    }
