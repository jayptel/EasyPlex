...
package com.easyplex.ui.downloadmanager.core;
...
import com.easyplex.ui.downloadmanager.core.system.SystemFacadeHelper;
import com.easyplex.ui.downloadmanager.core.utils.DateUtils;
import com.easyplex.ui.downloadmanager.core.utils.Utils;
import com.easyplex.ui.downloadmanager.receiver.NotificationReceiver;
...
import static com.easyplex.ui.downloadmanager.core.model.data.entity.DownloadInfo.VISIBILITY_HIDDEN;
import static com.easyplex.ui.downloadmanager.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE;
import static com.easyplex.ui.downloadmanager.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE_NOTIFY_COMPLETED;
import static com.easyplex.ui.downloadmanager.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION;
...
public class DownloadNotifier
{
    ...
    public static final String DEFAULT_NOTIFY_CHAN_ID = "com.easyplex.DEFAULT_NOTIFY_CHAN";
    public static final String FOREGROUND_NOTIFY_CHAN_ID = "com.easyplex.FOREGROUND_NOTIFY_CHAN";
    public static final String ACTIVE_DOWNLOADS_NOTIFY_CHAN_ID = "com.easyplex.CTIVE_DOWNLOADS_NOTIFY_CHAN";
    public static final String PENDING_DOWNLOADS_NOTIFY_CHAN_ID = "com.easyplex.PENDING_DOWNLOADS_NOTIFY_CHAN";
    public static final String COMPLETED_DOWNLOADS_NOTIFY_CHAN_ID = "com.easyplex.COMPLETED_DOWNLOADS_NOTIFY_CHAN";
    ...
    private void updateWithLocked(InfoAndPieces infoAndPieces, Notification notify, String tag, int type)
    {
        ...
        if (type == TYPE_ACTIVE || type == TYPE_PENDING) {
            ...
            Intent startupIntent = new Intent(appContext, BaseActivity.class);
            startupIntent.setAction(Intent.ACTION_MAIN);
            startupIntent.putExtra("download_on_progress", "yes");
        ...
        switch (type) {
            case TYPE_ACTIVE:
                builder.setContentTitle(info.mediaName);
            ...
            case TYPE_COMPLETE:
                if (isError) {
                    ...
                    builder.setContentText(info.mediaName);
                }
                break;
        }
