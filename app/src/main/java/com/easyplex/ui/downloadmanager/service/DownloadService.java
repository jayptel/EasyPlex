...
import com.easyplex.ui.downloadmanager.core.model.ChangeableParams;
import com.easyplex.ui.downloadmanager.core.model.DownloadEngine;
import com.easyplex.ui.downloadmanager.core.model.DownloadEngineListener;
...
public class DownloadService extends Service
{
    ...
    public static final String ACTION_SHUTDOWN = BuildConfig.APPLICATION_ID +".ui.downloadmanager.service.DownloadService.ACTION_SHUTDOWN";
    public static final String ACTION_RUN_DOWNLOAD = BuildConfig.APPLICATION_ID +".ui.downloadmanager.service.ACTION_RUN_DOWNLOAD";
    public static final String ACTION_CHANGE_PARAMS = BuildConfig.APPLICATION_ID +".ui.downloadmanager.service.ACTION_CHANGE_PARAMS";
    ...
    private void makeForegroundNotify()
    {
        ...
        Intent startupIntent = new Intent(getApplicationContext(), BaseActivity.class);
