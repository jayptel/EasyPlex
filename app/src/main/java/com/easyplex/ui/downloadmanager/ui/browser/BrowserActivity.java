...
package com.easyplex.ui.downloadmanager.ui.browser;
...
import com.easyplex.databinding.ActivityBrowserBottomAppBarBinding;
import com.easyplex.databinding.ActivityBrowserTopAppBarBinding;
...
import com.easyplex.ui.downloadmanager.ui.SendTextToClipboard;
import com.easyplex.ui.downloadmanager.ui.adddownload.AddDownloadActivity;
import com.easyplex.ui.downloadmanager.ui.adddownload.AddInitParams;
import com.easyplex.ui.downloadmanager.ui.browser.bookmarks.BrowserBookmarksActivity;
import com.easyplex.ui.downloadmanager.ui.browser.bookmarks.EditBookmarkActivity;
import com.easyplex.ui.downloadmanager.ui.settings.SettingsActivity;
        ...
        if (itemId == R.id.forward_menu) {
            ...
            disposables.add(viewModel.getBookmarkForCurrentPage()
                    ...
                    .subscribe(this::showEditBookmarkDialog,
                            (e) -> Timber.e(Log.getStackTraceString(e)))
            );
