...
import com.easyplex.databinding.DialogAddDownloadBinding;
...
import com.easyplex.ui.downloadmanager.core.system.FileSystemContracts;
import com.easyplex.ui.downloadmanager.core.utils.Utils;
import com.easyplex.ui.downloadmanager.ui.BaseAlertDialog;
import com.easyplex.ui.downloadmanager.ui.ClipboardDialog;
import com.easyplex.ui.downloadmanager.ui.FragmentCallback;
import com.easyplex.ui.downloadmanager.ui.PermissionDeniedDialog;
...
public class AddDownloadDialog extends DialogFragment {
    ...
    public void onResume()
    {
        ...
        /* Back button handle */
        Objects.requireNonNull(getDialog()).setOnKeyListener((DialogInterface dialog, int keyCode, KeyEvent event) -> {
                ...
                case POSITIVE_BUTTON_CLICKED:
                    ...
                    if (dialog != null) {
                        ...
                        if (!TextUtils.isEmpty(userAgent))
                            disposables.add(viewModel.addUserAgent(new UserAgent(Objects.requireNonNull(userAgent)))
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        AddInitParams initParams = Objects.requireNonNull(getArguments()).getParcelable(TAG_INIT_PARAMS);
        /* Clear init params */
    ...
    private final ActivityResultLauncher<String> storagePermission = registerForActivityResult(
            ...
            isGranted -> {
                if (Boolean.TRUE.equals(!isGranted) && Utils.shouldRequestStoragePermission(activity)) {
    ...
    private void addDownload()
    {
        ...
        Toast.makeText(activity.getApplicationContext(),
                getString(R.string.download_ticker_notify, viewModel.params.getMediaName()),
                Toast.LENGTH_SHORT)
                .show();
    ...
    final ActivityResultLauncher<Uri> chooseDir = registerForActivityResult(
            ...
            uri -> {
                ...
                try {
                    ...
                    Timber.e("Unable to open directory: " + Log.getStackTraceString(e));
