...
import static com.easyplex.util.Constants.CUSTOM_SEEK_CONTROL_STATE;
import static com.easyplex.util.Constants.DEFAULT_FREQUENCY;
import static com.easyplex.util.Constants.DEFAULT_MEDIA_COVER;
import static com.easyplex.util.Constants.EDIT_CUSTOM_SEEK_CONTROL_STATE;
...
import com.easyplex.ui.player.presenters.ScalePresenter;
...
public class PlayerController extends Observable implements TubiPlaybackControlInterface, Player.Listener, SeekBar.OnSeekBarChangeListener{
    ...
    public void triggerPlayerLocked2() {
        ...
        //mScalePresenter.lockedClicked(mEasyPlexPlayerView.getControlView().findViewById(R.id.player_locked_icon));
