 ...
 */
package com.easyplex.ui.player.cast.queue.ui;
...
/**
 * An implementation of the {@link ItemTouchHelper.Callback}.
 */
public class QueueItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE && viewHolder instanceof QueueListAdapter.ItemTouchHelperViewHolder) {
