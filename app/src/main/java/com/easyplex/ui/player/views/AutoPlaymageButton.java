...
public class AutoPlaymageButton extends ImageButton {
    ...
    public AutoPlaymageButton(Context context) {
        super(context);
        init(null);
    }

    public AutoPlaymageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public AutoPlaymageButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @BindingAdapter("setCheckedState")
    public static void onStateChanged(AutoPlaymageButton imageButton, boolean checked) {
