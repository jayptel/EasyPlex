...
import com.easyplex.databinding.RowDiscoverStyleBinding;
...
public class DiscoverStyleAdapter extends RecyclerView.Adapter<DiscoverStyleAdapter.MainViewHolder> {
    ...
    public DiscoverStyleAdapter(MediaRepository mediaRepository) {
    ...
    class MainViewHolder extends RecyclerView.ViewHolder {
        ...
        void onBind(final int position) {
            ...
            binding.discoverCardView.setOnClickListener(v -> {
                ...
                ByGenreAdapter byGenreAdapter = new ByGenreAdapter(context, ItemAnimation.FADE_IN);
