...
import static com.easyplex.util.Constants.AUTH_EMAIL;
import static com.easyplex.util.Constants.AUTH_EXPIRED_DATE;
import static com.easyplex.util.Constants.AUTH_ID;
import static com.easyplex.util.Constants.AUTH_NAME;
import static com.easyplex.util.Constants.PREMUIM;
import static com.easyplex.util.Constants.PREMUIM_MANUAL;
import static com.easyplex.util.Constants.USER_PROFILE_AVATAR;
import static com.easyplex.util.Constants.USER_PROFILE_ID;
import static com.easyplex.util.Constants.USER_PROFILE_NAME;
...
public class AuthManager {
    ...
    public Profile getSettingsProfile(){
        ...
        profile.setName(prefs.getString(USER_PROFILE_NAME, "user"));
