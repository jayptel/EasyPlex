...
public class MediaDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    public MediaDataSource(String genreId, SettingsManager settingsManager){
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull LoadInitialCallback<Integer, Media> callback) {
        ...
        Call<GenresData> call = apiInterface.getMoviesTypeGenreByID(genreId,settingsManager.getSettings().getApiKey(),FIRST_PAGE);
    ...
    public void loadBefore(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<Integer, Media> callback) {
        ...
        ApiInterface apiInterface = ServiceGenerator.createService(ApiInterface.class);
        Call<GenresData> call = apiInterface.getMoviesTypeGenreByID(genreId,settingsManager.getSettings().getApiKey(),params.key);
