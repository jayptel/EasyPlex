...
public class MovieLatestDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    MovieLatestDataSource(ApiInterface requestInterface, SettingsManager settingsManager) {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, Media> callback) {
        ...
        Call<GenresData> call = requestInterface.getByLatest(settingsManager.getSettings().getApiKey(),FIRST_PAGE);
    ...
    public void loadBefore(@NonNull final LoadParams<Integer> params, @NonNull final LoadCallback<Integer, Media> callback) {
        ...
        Call<GenresData> call = requestInterface.getByLatest(settingsManager.getSettings().getApiKey(),params.key);
        call.enqueue(new Callback<GenresData>() {
