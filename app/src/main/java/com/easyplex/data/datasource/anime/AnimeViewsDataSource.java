...
public class AnimeViewsDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    AnimeViewsDataSource(ApiInterface requestInterface, SettingsManager settingsManager) {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, Media> callback) {
        ...
        Call<GenresData> call = requestInterface.getByViewsAnimes(settingsManager.getSettings().getApiKey(),FIRST_PAGE);
