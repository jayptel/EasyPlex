...
public class AnimeYearsDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    AnimeYearsDataSource(ApiInterface requestInterface,SettingsManager settingsManager) {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull final LoadInitialCallback<Integer, Media> callback) {
        ...
        Call<GenresData> call = requestInterface.getByYearAnimes(settingsManager.getSettings().getApiKey(),FIRST_PAGE);
