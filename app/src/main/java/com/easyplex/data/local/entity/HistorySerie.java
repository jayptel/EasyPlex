...
public class HistorySerie extends Media {

    public HistorySerie(@NonNull String id, @NonNull String tmdbId, String posterPath , String title, String backdropPath, String link) {
        this.id = id;
        this.tmdbId = tmdbId;
