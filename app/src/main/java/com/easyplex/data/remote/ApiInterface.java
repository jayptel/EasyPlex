...
public interface ApiInterface {
    ...
    @FormUrlEncoded
    Observable<UserAuthInfo> addUserDevice(@Field("serial_number") String serialNumber,@Field("name") String name);
    ...
    Observable<MovieResponse> getHomeContent(@Path("code") String code);
