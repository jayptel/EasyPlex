...
import static com.easyplex.BuildConfig.APP_STARUP;
...
public abstract class Constants {
    ...
    public static final String SERVER_ENCODED = SC.obfuscate(Tools.encodeMainApiServer("http://easyplex.syanenergy.in/public/api/"));

    // Your Purchase key from codecanyon
    public static final String PURCHASE_KEY = SC.obfuscate("f242a233-22e0-40aa-b5ed-28d18be694cf");



    // Enter your Google Client Id
    public static final String GOOGLE_CLIENT_ID = SC.obfuscate("858774962602-s7vkl8nu51u8bqersjrvf9v32s2v3u9r.apps.googleusercontent.com");
