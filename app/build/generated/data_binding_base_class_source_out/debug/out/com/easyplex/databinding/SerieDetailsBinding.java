...
public abstract class SerieDetailsBinding extends ViewDataBinding {
  ...
  protected SerieDetailsBinding(Object _bindingComponent, View _root, int _localFieldCount,
      LinearLayout ButtonPlayTrailer, LinearLayout MoreOptionsLinear,
      LinearLayout NavigationTabLayout, LinearLayout RecycleViewTrailerLayout,
      ...
      LinearLayout review, ImageView reviewImage, RecyclerView rvMylike,
      NestedScrollView scrollView, CoordinatorLayout serieCoordinator, TextView serieName,
      ReadMoreTextView serieOverview, TextView serieTitle, LinearLayout shareIcon,
      TextView timeRemaning, Toolbar toolbar, LinearLayout topResume,
      RelativeLayout unityBannerViewContainer, TextView userReview, TextView viewMovieRating,
  ...
  @NonNull
  public static SerieDetailsBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.serie_details, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static SerieDetailsBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<SerieDetailsBinding>inflateInternal(inflater, R.layout.serie_details, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.serie_details, null, false, component)
   */
  @NonNull
  @Deprecated
  public static SerieDetailsBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<SerieDetailsBinding>inflateInternal(inflater, R.layout.serie_details, null, false, component);
  }
   ...
   */
  @Deprecated
  public static SerieDetailsBinding bind(@NonNull View view, @Nullable Object component) {
    return (SerieDetailsBinding)bind(component, view, R.layout.serie_details);
  }
}
