...
public class ItemTopttenBindingImpl extends ItemTopttenBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.mostrarTop10, 8);
        sViewsWithIds.put(R.id.mgenres, 9);
        sViewsWithIds.put(R.id.movietitle, 10);
        sViewsWithIds.put(R.id.rating_bar, 11);
        sViewsWithIds.put(R.id.view_movie_rating, 12);
    }
    // views
    @NonNull
    ...
    public ItemTopttenBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private ItemTopttenBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (android.widget.FrameLayout) bindings[3]
            , (android.widget.LinearLayout) bindings[7]
            , (com.easyplex.util.GridItemImageView) bindings[4]
            , (com.easyplex.util.Outline) bindings[9]
