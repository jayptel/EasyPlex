...
public final class CastersViewModel_Factory implements Factory<CastersViewModel> {
  ...
  public CastersViewModel_Factory(Provider<MediaRepository> mediaRepositoryProvider,
  ...
  public static CastersViewModel_Factory create(Provider<MediaRepository> mediaRepositoryProvider,
      Provider<ApiInterface> requestInterfaceProvider,
      Provider<SettingsManager> settingsManagerProvider) {
    return new CastersViewModel_Factory(mediaRepositoryProvider, requestInterfaceProvider, settingsManagerProvider);
  }
  ...
  public static CastersViewModel newInstance(MediaRepository mediaRepository,
    ...
    return new CastersViewModel(mediaRepository, requestInterface, settingsManager);
  }
}
