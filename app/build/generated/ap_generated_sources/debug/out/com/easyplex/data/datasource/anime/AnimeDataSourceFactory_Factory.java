...
public final class AnimeDataSourceFactory_Factory implements Factory<AnimeDataSourceFactory> {
  ...
  public AnimeDataSourceFactory_Factory(Provider<ApiInterface> requestInterfaceProvider,
  ...
  public static AnimeDataSourceFactory_Factory create(
      Provider<ApiInterface> requestInterfaceProvider,
      Provider<SettingsManager> settingsManagerProvider) {
    return new AnimeDataSourceFactory_Factory(requestInterfaceProvider, settingsManagerProvider);
  }

  public static AnimeDataSourceFactory newInstance(ApiInterface requestInterface,
      SettingsManager settingsManager) {
    return new AnimeDataSourceFactory(requestInterface, settingsManager);
  }
}
