...
public final class StreamListDao_Impl implements StreamListDao {
    ...
    this.__insertionAdapterOfStream = new EntityInsertionAdapter<Stream>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, Stream value) {
        ...
        if (value.getSkiprecapStartIn() == null) {
          ...
          stmt.bindLong(8, value.getSkiprecapStartIn());
        }
        if (value.getHasrecap() == null) {
          stmt.bindNull(9);
        } else {
          stmt.bindLong(9, value.getHasrecap());
        }
        if (value.getImdbExternalId() == null) {
          stmt.bindNull(10);
        } else {
          stmt.bindString(10, value.getImdbExternalId());
        }
        if (value.getSubtitle() == null) {
          stmt.bindNull(11);
        } else {
          stmt.bindString(11, value.getSubtitle());
        }
        if (value.getType() == null) {
          stmt.bindNull(12);
        } else {
          stmt.bindString(12, value.getType());
        }
        ...
        if (value.getSubstype() == null) {
          ...
          stmt.bindString(14, value.getSubstype());
        }
        stmt.bindLong(15, value.getContentLength());
        if (value.getOverview() == null) {
          stmt.bindNull(16);
        } else {
          stmt.bindString(16, value.getOverview());
        }
        if (value.getGenreName() == null) {
          stmt.bindNull(17);
        } else {
          stmt.bindString(17, value.getGenreName());
        }
        if (value.getLinkpreview() == null) {
          stmt.bindNull(18);
        } else {
          stmt.bindString(18, value.getLinkpreview());
        }
        if (value.getMinicover() == null) {
          stmt.bindNull(19);
        } else {
          stmt.bindString(19, value.getMinicover());
        }
        if (value.getPreviewPath() == null) {
          stmt.bindNull(20);
        } else {
          stmt.bindString(20, value.getPreviewPath());
        }
        if (value.getTrailerUrl() == null) {
          stmt.bindNull(21);
        } else {
          stmt.bindString(21, value.getTrailerUrl());
        }
        stmt.bindDouble(22, value.getVoteAverage());
        if (value.getVoteCount() == null) {
          stmt.bindNull(23);
        } else {
          stmt.bindString(23, value.getVoteCount());
        }
        stmt.bindLong(24, value.getLive());
        stmt.bindLong(25, value.getPremuim());
        stmt.bindLong(26, value.getNewEpisodes());
        stmt.bindLong(27, value.getUserHistoryId());
        stmt.bindLong(28, value.getVip());
        stmt.bindLong(29, value.getHls());
        stmt.bindLong(30, value.getStreamhls());
  ...
  @Override
  public boolean isStreamFavorite(final int id) {
    final String _sql = "SELECT EXISTS(SELECT * FROM stream WHERE id = ?)";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, id);
    __db.assertNotSuspendingTransaction();
